...
class CreateNewContact(unittest.TestCase):
    ...
    def fill_new_form_for_add_new_contact(self, wd, new_contact):
    ...
    def test_create_new_contact(self):
        ...
        self.fill_new_form_for_add_new_contact(wd, New_contact(firstname="Alex", middlename="fffefe", lastname="wfawf", nickname="fwwfett", title="wfwfwer", company="erreeg",
