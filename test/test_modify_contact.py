...
from model.group_modify_contact import Modify_contact

def test_modify_contact(app):
    app.session.login(username="admin", password="secret")
    app.group_new_contact.modify_contact(
        Modify_contact(firstname="Niokolay", middlename="ggggg", lastname="Stekolnikov", nickname="Steklov", title="razotr",
                    company="bichpacket",
